...
var readTeamSheet = function(teamSheetFile) {
  ...
  lines.forEach( function (line) {
      ...
      ++lineCount;
      pieces = line.split("\t");  // file is tab-delimited
      ...
      if (lineCount > 3) {  // first three lines are header information
        ...
        obj = {};
        obj['Downloaded']    =  pieces[0];  // not going to use this
        if (obj.Downloaded.toLowerCase() != "yes") {
        ...
        obj['checkedByQA']   =  pieces[1];  // not going to use this
