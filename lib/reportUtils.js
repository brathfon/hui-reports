 ...
 * @param  {integer} headerLinesToSkip  (optional) number of header lines to skip
 ...
 */
const delimitedFileToArrayOfArrays_ = function(delimitedFile, delimitingChar, headerLinesToSkip) {
  ...
  let startingIndex = 0;
  if (headerLinesToSkip) {  // if defined
    startingIndex = headerLinesToSkip;
  }
 ...
 * @param  {boolean} headerLinesToSkip (optional) number of header lines to skip
 * @return {type}                 array of arrays of strings
 *
 */
const tsvFileToArrayOfArrays = function(tsvFile, headerLinesToSkip) {
  return delimitedFileToArrayOfArrays_(tsvFile, '\t', headerLinesToSkip);
